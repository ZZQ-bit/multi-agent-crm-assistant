...
public final class ShiroFilter {
    ...
    private static void addAuthenticationFilters() {
        ...
        FILTER_CHAIN_DEFINITION_MAP.put("/front/login", "anon");
        FILTER_CHAIN_DEFINITION_MAP.put("/logout", "anon");
        FILTER_CHAIN_DEFINITION_MAP.put("/front/logout", "anon");
        FILTER_CHAIN_DEFINITION_MAP.put("/is-login", "anon");
        FILTER_CHAIN_DEFINITION_MAP.put("/front/is-login", "anon");
        FILTER_CHAIN_DEFINITION_MAP.put("/get-key", "anon");
        FILTER_CHAIN_DEFINITION_MAP.put("/front/get-key", "anon");
    ...
    private static void addPublicPathFilters() {
        ...
        FILTER_CHAIN_DEFINITION_MAP.put("/ai/deal-desk/**", "anon");
        FILTER_CHAIN_DEFINITION_MAP.put("/front/ai/deal-desk/**", "anon");
